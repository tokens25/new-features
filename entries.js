...
window.DAZN_ENTRIES = [
  ...
  },
  {
    ...
    name: "Scores",
    tagline: "Everything you need before kick-off.",
    ctaText: "Explore Scores",
    theme: "dark",
    heroImage: "assets/img/final.png",
    closerImages: ["assets/img/g1.png", "assets/img/image5.png", "assets/img/image6.png"],
    highlightImages: ["assets/img/image22.png", "assets/img/73.png", "assets/img/g3.png"],
    highlightCaps: ["", "Live win probability, updated in real time.", ""],
    highlightsFill: true,
    highlightsThree: true,
    highlightsCaptionInside: true,
    worksImages: ["assets/img/how1.png", "assets/img/12345.png"],
    statementImage: "assets/img/hero.png",
    galleryImages: ["assets/img/phone.png", "assets/img/ipad.png", "assets/img/tv1.png", "assets/img/desktop1.png"],
    hideGoodToKnow: true,
    labelClass: "label--new",
    labelText: "New release",
    date: "July 27",
    ...
    desc: "From kickoff to full time, DAZN brings live win probability, standings, and match insights into one connected scores experience.",
    tip: "Recent form and head-to-head results update after every fixture, so the picture is never out of date.",
    sections: [
      { heading: "See how the game is shifting", text: "A live win-probability meter updates after every key moment of the match." },
      { heading: "Go deeper than the score", text: "Match insights surface the stats and storylines that matter most, from form streaks to head-to-head history." }
    ],
