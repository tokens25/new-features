...
window.DAZN_ENTRIES = [
  ...
  },
  {
    ...
    highlightImages: ["assets/img/scores-highlight-1.png", "assets/img/scores-highlight-2.png", "assets/img/scores-highlight-3.png", "assets/img/scores-highlight-4.png"],
    highlightItems: [
      { title: "Chat", text: "Describe the highlight you want and AI cuts the reel in seconds." },
      { title: "Clip preview", text: "Play any result inline — check the prompt and description before you save." },
      { title: "Navigate library", text: "Every reel lands in your library, filterable by Today, Yesterday or Last 7 days." },
      { title: "Prompt suggestions", text: "No exact match? AI surfaces close prompts to get you to the right clip." }
    ],
    highlightsFill: true,
    highlightsCaptionBelow: true,
    worksImages: ["assets/img/scores-works-1.png", "assets/img/scores-works-2.png"],
    statementImage: "assets/img/scores-statement.png",
    galleryImages: ["assets/img/gallery-iphone.png", "assets/img/scores-gallery-myclips-grid.png", "assets/img/scores-gallery-myclips-phone.png", "assets/img/gallery-laptop.png"],
    hideGauges: true,
